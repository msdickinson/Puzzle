...
class Network {
    ...
    UpdateName(socket, name, roomId = null) {
        let data = new DataTypes_1.UpdateNameRequest();
    ...
    SendMessage(socket, message, roomId = null) {
        let data = new DataTypes_1.SendMessageRequest();
    ...
    SendLog(socket, logItems, roomId = null) {
        let data = new DataTypes_1.SendLogRequest();
