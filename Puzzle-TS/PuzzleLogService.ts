import {
    LogItem, PuzzleLogState, PuzzleLogicState
...
class PuzzleLogService {
    ...
    public AdvanceTicks(puzzle: PuzzleLogic, logicState: PuzzleLogicState, logState: PuzzleLogState, tick: number, useLog: boolean = true) {
        let log;
        if (tick === 0) {
            return;
        }
    ...
    public AdvanceToEndOfLog(puzzle: PuzzleLogic, logicState: PuzzleLogicState, logState: PuzzleLogState, startingLogPostion: number) {
